...
function compile {
  ...
  CXX_FLAGS='-Wno-missing-field-initializers -Wno-deprecated-declarations -Wno-inconsistent-missing-override -Wno-macro-redefined -UUNLIKELY'
  COMPILE_OPTION="-DCMAKE_CXX_FLAGS=\"$CXX_FLAGS\" -DVELOX_ENABLE_PARQUET=ON -DVELOX_BUILD_TESTING=OFF -DCMAKE_BUILD_TYPE=Debug -DVELOX_MONO_LIBRARY=ON -DVELOX_BUILD_RUNNER=OFF -DVELOX_SIMDJSON_SKIPUTF8VALIDATION=ON -DCMAKE_POLICY_VERSION_MINIMUM=3.5"
