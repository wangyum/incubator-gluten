...
function apply_compilation_fixes {
  ...
  sudo cp ${current_dir}/modify_arrow_cmake.patch ${velox_home}/CMake/resolve_dependency_modules/arrow/
  ...
  git add ${velox_home}/CMake/resolve_dependency_modules/arrow/modify_arrow_cmake.patch
